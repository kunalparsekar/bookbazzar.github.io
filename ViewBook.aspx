<%@ page title="" language="C#" masterpagefile="~/Book Bazaar/Main_MasterPage.master" autoeventwireup="true" inherits="ViewBook, App_Web_hbl4vhqd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h2 align="center">
        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" NavigateUrl="Login.aspx" CssClass="viewcart">View Cart</asp:HyperLink>
    </h2>
    <div style="width: 80%; padding: 20px 20px 20px 20px" align="center">
        <asp:DataList ID="DataList1" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="5px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource1" GridLines="Both" OnItemCommand="DataList1_ItemCommand" RepeatDirection="Horizontal" Width="425px" RepeatColumns="6">
